...
import HomeManufacture from './pages/Manufacturer/HomeManufacture'
...
import HomeThirdParty from './pages/ThirdParty/HomeThirdParty'
import ShipThirdParty from './pages/ThirdParty/ShipThirdParty'
import HomeDeliveryHub from './pages/DeliveryHub/HomeDeliveryHub'
...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App" style={{ background: '#f6ffee' }}>
